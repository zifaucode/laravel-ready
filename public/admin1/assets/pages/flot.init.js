...
!function($) {
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var pcolors = ['#f0f1f4', '#35bf84', '#1699dd'];
          ...
          var datas = [20,30, 15];
          var colors = ['#35bf84','#1699dd', "#ebeff2"];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#1699dd']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ['#f0f1f4', '#35bf84', '#1699dd'];
