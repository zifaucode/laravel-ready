...
<body id="kt_body" class="auth-bg">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-center flex-column-fluid p-10">
            <!--begin::Illustration-->
            <img src="../../../fix-theme/assets/media/illustrations/sigma-1/9-dark.png" alt="" class="mw-100 mb-10 h-lg-450px" />
            <!--end::Illustration-->
            <!--begin::Message-->
            <h1 class="fw-bold mb-10 text-center" style="color: #A3A3C7">Website Sedang Maintenance</h1>

            <h1 class="fw-bold mb-10 text-center" style="color: #A3A3C7">Mohon Maaf Atas Ketidak nyamanan nya 🙏</h1>
